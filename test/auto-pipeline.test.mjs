...
test('自动任务类型串联打标、事件卡与事件研判', () => {
  ...
  assert.deepEqual(AI_JOB_TYPES, ['tag','retag','event-cards','research','pipeline-failure-retry','breaking-analysis','article','article-review','daily','tutorial','typeset','social-card','social-card-beautify','cover-image','auto']);
