 ...
 * 账号上下文领域模型。
 *
 * 这里只保存默认值、字段规范和面向模型的纯格式化逻辑，不负责文件、缓存或工作区访问。
 */
...
export function getDefaultAccountContext() {
  return {
    name: '我的公众号',
...
export function formatAccountContext(context = getDefaultAccountContext()) {
  const ctx = context || {};
  const parts = [];
...
export function isAccountContextConfigured(context) {
