...
import { getAccountContext, loadAccountContext } from '../../../platform/application/account-context-service.mjs';
...
// 保持 application 旧公开能力可用；实现位于纯领域规则模块。
export { applySkillEdits } from '../domain/skill-editing.mjs';
